...
public class MetsBuildAndValidate {
	public static void main(String[] args) {
		try {
			...
			SIPDescriptiveMetadata dcMetadata = new SIPDescriptiveMetadata(Paths.get("data/dc.xml"), Paths.get("data/dc.xsd"),MetadataType.DC);
			SIPDescriptiveMetadata textMetadata = new SIPDescriptiveMetadata(Paths.get("data/descriptive.txt"), null, MetadataType.TEXTMD);
