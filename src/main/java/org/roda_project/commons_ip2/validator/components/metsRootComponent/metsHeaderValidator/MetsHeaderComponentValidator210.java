...
public class MetsHeaderComponentValidator210 extends MetsValidatorImpl {
  /**
   ...
   *           if some error occurs
   */
  public MetsHeaderComponentValidator210() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    MetsHeaderValidator generator = metsHeaderValidatorFactory.getGenerator("2.1.0");
