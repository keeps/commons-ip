...
public class MetsComponentValidator210 extends MetsValidatorImpl {
   ...
   *           if some error occurs
   */
  public MetsComponentValidator210() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    MetsValidator generator = metsValidatorFactory.getGenerator("2.1.0");
    /* CSIP1 */
