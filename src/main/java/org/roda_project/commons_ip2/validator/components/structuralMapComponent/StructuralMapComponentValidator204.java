...
import org.roda_project.commons_ip2.validator.components.fileSectionComponent.FileSecValidatorFactory;
...
public class StructuralMapComponentValidator204 extends MetsValidatorImpl {
  /**
   * {@link Logger}.
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(StructuralMapComponentValidator204.class);
   ...
   */
  public StructuralMapComponentValidator204() {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    StructMapValidator generator = structMapValidatorFactory.getGenerator("2.0.4");
