...
public class FileSectionComponentValidator204 extends MetsValidatorImpl {
  /**
   ...
   *           if some error occurs.
   */
  public FileSectionComponentValidator204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    FileSecValidator generator = fileSecValidatorFactory.getGenerator("2.0.4");
