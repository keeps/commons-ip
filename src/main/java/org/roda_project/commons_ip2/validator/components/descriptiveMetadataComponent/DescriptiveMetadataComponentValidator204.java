...
public class DescriptiveMetadataComponentValidator204 extends MetsValidatorImpl {
   ...
   *           if some error occurs.
   */
  public DescriptiveMetadataComponentValidator204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    DmdSecValidator generator = dmdSecValidatorFactory.getGenerator("2.0.4");
