...
public class StructuralMapComponentValidator210 extends MetsValidatorImpl {
  /**
   * {@link Logger}.
   */
  private static final Logger LOGGER = LoggerFactory.getLogger(StructuralMapComponentValidator210.class);
   ...
   */
  public StructuralMapComponentValidator210() {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    StructMapValidator generator = structMapValidatorFactory.getGenerator("2.1.0");
