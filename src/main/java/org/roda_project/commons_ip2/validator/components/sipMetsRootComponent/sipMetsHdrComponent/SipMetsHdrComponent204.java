...
import org.roda_project.commons_ip2.validator.components.sipMetsRootComponent.sipMetsComponent.SipMetsValidatorFactory;
...
public class SipMetsHdrComponent204 extends MetsValidatorImpl {
  /**
   ...
   *           if some error occurs.
   */
  public SipMetsHdrComponent204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    SipMetsHdrValidator generator = sipMetsHdrValidatorFactory.getGenerator("2.0.4");
