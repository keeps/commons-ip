...
public class MetsComponentValidator204 extends MetsValidatorImpl {
   ...
   *           if some error occurs
   */
  public MetsComponentValidator204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    MetsValidator generator = metsValidatorFactory.getGenerator("2.0.4");
    /* CSIP1 */
