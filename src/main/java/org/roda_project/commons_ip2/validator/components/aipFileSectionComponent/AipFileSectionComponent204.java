...
public class AipFileSectionComponent204 extends MetsValidatorImpl {
  /**
   ...
   */
  public AipFileSectionComponent204() {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    AipFileValidator generator = aipFileValidatorFactory.getGenerator("2.0.4");
    ...
    if (isToValidate) {
      ...
      ResultsUtils.addResult(results, ConstantsAIPspec.VALIDATION_REPORT_SPECIFICATION_AIP9_ID,
        generator.validateAIP9(metsValidatorState).setSpecification(generator.getAIPVersion()));
      ...
      ResultsUtils.addResults(results, new ReporterDetails(generator.getAIPVersion(), message, true, true),
