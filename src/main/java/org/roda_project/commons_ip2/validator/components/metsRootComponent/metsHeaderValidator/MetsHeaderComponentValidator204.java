...
public class MetsHeaderComponentValidator204 extends MetsValidatorImpl {
  /**
   ...
   *           if some error occurs
   */
  public MetsHeaderComponentValidator204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    MetsHeaderValidator generator = metsHeaderValidatorFactory.getGenerator("2.0.4");
    ...
    if (ResultsUtils.isResultValid(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP117_ID)) {
      ...
      ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP9_ID,
        generator.validateCSIP9(metsValidatorState, metsHdr, oaisPackageTypes).setSpecification(generator.getCSIPVersion()));
      ...
      if (metsValidatorState.isRootMets()) {
        ...
        ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP10_ID, generator
          .validateCSIP10(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));
        ...
        if (ResultsUtils.isResultValid(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP10_ID)) {
          ...
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP11_ID, generator
            .validateCSIP11(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));

          /* CSIP12 */
          notifyObserversValidationStarted(moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP12_ID);
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP12_ID, generator
            .validateCSIP12(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));

          /* CSIP13 */
          notifyObserversValidationStarted(moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP13_ID);
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP13_ID, generator
            .validateCSIP13(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));

          /* CSIP14 */
          notifyObserversValidationStarted(moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP14_ID);
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP14_ID, generator
            .validateCSIP14(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));

          /* CSIP15 */
          notifyObserversValidationStarted(moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP15_ID);
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP15_ID, generator
            .validateCSIP15(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));

          /* CSIP16 */
          notifyObserversValidationStarted(moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP16_ID);
          ResultsUtils.addResult(results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP16_ID, generator
            .validateCSIP16(metsValidatorState, agents).setSpecification(generator.getCSIPVersion()));
        } else {
