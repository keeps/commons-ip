...
public class AdministritiveMetadataComponentValidator204 extends MetsValidatorImpl {
   ...
   *           if some error occurs.
   */
  public AdministritiveMetadataComponentValidator204() throws IOException, ParserConfigurationException, SAXException {
  ...
  public Map<String, ReporterDetails> validate(final StructureValidatorState structureValidatorState,
    ...
    AmdSecValidator generator = amdSecValidatorFactory.getGenerator("2.0.4");
