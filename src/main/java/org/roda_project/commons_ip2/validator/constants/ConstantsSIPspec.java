...
public class ConstantsSIPspec {
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP1_DESCRIPTION = "An optional short text describing the contents of the package, e.g. “Accounting records of 2017”.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP4_DESCRIPTION = "@csip:OAISPACKAGETYPE is used with the value “SIP”.See also: OAIS Package type";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP13_DESCRIPTION = "The archival creator agent has a note providing a unique identification code for the archival creator.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP14_DESCRIPTION = "The archival creator agent note is typed with the value of “IDENTIFICATIONCODE”.See also: Note type";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP16_DESCRIPTION = "The role of the person(s) or institution(s) responsible for creating and/or submitting the package";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP19_DESCRIPTION = "The submitting agent has a note providing a unique identification code for the archival creator.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP20_DESCRIPTION = "The submitting agent note is typed with the value of “IDENTIFICATIONCODE”.See also: Note type";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP30_DESCRIPTION = "The preservation agent has a note providing a unique identification code for the archival creator.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP31_DESCRIPTION = "The preservation agent note is typed with the value of “IDENTIFICATIONCODE”.See also: Note type";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP33_DESCRIPTION = "The version of the file format when the use of PREMIS has not been agreed upon in the submission agreement. Example: “1.0”";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP34_DESCRIPTION = "The name of the format registry used to identify the file format when the use of PREMIS has not been agreed upon in the submission agreement. Example:“PRONOM”";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_SIP35_DESCRIPTION = "Key of the file format in the registry when use of PREMIS has not been agreed upon in the submission agreement. Example: “fmt/101”";
