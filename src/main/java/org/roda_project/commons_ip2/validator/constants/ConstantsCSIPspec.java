...
public final class ConstantsCSIPspec {
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR1_DESCRIPTION = "Any Information Package MUST be included within a single physical root folder "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR2_DESCRIPTION = "The Information Package root folder SHOULD be named with the ID or name "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR3_DESCRIPTION = "The Information Package root folder MAY be compressed "
    + "(for example by using TAR or ZIP). " + "Which specific compression format to use "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR4_DESCRIPTION = "The Information Package root folder MUST include a file named METS.xml. "
    + "This file MUST contain metadata that identifies the package, " + "provides a high-level package description, "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR5_DESCRIPTION = "The Information Package root folder SHOULD include a folder named metadata, "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR8_DESCRIPTION = "If any other metadata are available, they MAY be included in "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR10_DESCRIPTION = "The representations folder SHOULD include a sub-folder for each individual representation "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR11_DESCRIPTION = "The representation folder SHOULD include a sub-folder "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR12_DESCRIPTION = "The representation folder SHOULD include a metadata "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR13_DESCRIPTION = "The representation folder SHOULD include a sub-folder "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR15_DESCRIPTION = "We recommend including all XML schema documents "
    + "for any structured metadata within package. " + "These schema documents SHOULD be placed in a sub-folder "
    + "called schemas within the Information Package " + "root folder and/or the representation folder.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIPSTR16_DESCRIPTION = "We recommend including any supplementary documentation for the "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP9_DESCRIPTION = "mets/metsHdr/@csip:OAISPACKAGETYPE is an additional "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP10_DESCRIPTION = "A mandatory agent element records the software used to create the package. "
    + "Other uses of agents may be described in any local " + "implementations that extend the profile.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP14_DESCRIPTION = "The mandatory agent’s name element records "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP16_DESCRIPTION = "The mandatory agent element’s note child has a "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP18_DESCRIPTION = "An xml:id identifier for the descriptive metadata section ( <dmdSec> ) "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP24_DESCRIPTION = "The actual location of the resource. "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP25_DESCRIPTION = "Specifies the type of metadata in the "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP30_DESCRIPTION = "The type of checksum following the value list present in the METS-standard which has been "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP46_DESCRIPTION = "An xml:id identifier for the rights metadata section ( <rightsMD> ) "
    + "used for internal package references. It must be unique within the package.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP51_DESCRIPTION = "The actual location of the resource. "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP52_DESCRIPTION = "Specifies the type of metadata in the referenced file. "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP57_DESCRIPTION = "The type of checksum following the value list present in the "
    + "METS-standard which has been used for " + "calculating the checksum for the referenced file.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP59_DESCRIPTION = "An xml:id identifier for the file section used for internal package references. "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP60_DESCRIPTION = "All documentation pertaining to the transferred content is placed "
    + "in one or more file group elements " + "with mets/fileSec/fileGrp/@USE attribute value “Documentation”.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP63_LOCATION = "mets/fileSec/fileGrp[@csip:CONTENTINFORMATIONTYPE=’OTHER’]"
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP65_DESCRIPTION = "An xml:id identifier for the file group used for internal package references. "
    + "It must be unique within the package.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP79_DESCRIPTION = "The actual location of the resource. "
    + "We recommend recording a URL type filepath within this attribute.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP88_DESCRIPTION = "The metadata referenced in the administrative and/or descriptive "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP91_DESCRIPTION = "When there is administrative metadata and the amdSec is present, "
    + "all administrative metadata " + "MUST be referenced via the administrative sections different identifiers."
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP92_DESCRIPTION = "When there are descriptive metadata and one or more dmdSec is present, "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP93_DESCRIPTION = "The documentation referenced in the file section file groups "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP95_DESCRIPTION = "The documentation division <div> element in the package uses the value "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP96_DESCRIPTION = "All file groups containing documentation described in the package are "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP97_DESCRIPTION = "The schemas referenced in the file section "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP100_DESCRIPTION = "All file groups containing schemas described in the package are referenced "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP101_DESCRIPTION = "When no representations are present the content referenced in the file section file "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP103_DESCRIPTION = "The package’s content division <div> element must have the "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP104_DESCRIPTION = "All file groups containing content described in the package are referenced "
    + "via the relevant file group identifiers. One file group reference per fptr-element.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP105_DESCRIPTION = "When a package consists of multiple representations, each described by a representation "
    + "level METS.xml document," + " there is a discrete representation div element for each representation. "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP107_DESCRIPTION = "The package’s representation division <div> element @LABEL attribute value must be "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP108_DESCRIPTION = "The file group containing the files described in the package are "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP109_DESCRIPTION = "The division <div> of the specific representation includes one occurrence of the "
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_CSIP110_DESCRIPTION = "The actual location of the resource. We recommend recording a "
