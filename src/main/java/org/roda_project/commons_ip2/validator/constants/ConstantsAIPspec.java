...
public class ConstantsAIPspec {
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_AIP9_DESCRIPTION = "Identifier of a file which is part of the AIP File identifier; must be unique and start with the prefix ID";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_AIP10_DESCRIPTION = "Used to link it to relevant administrative metadata sections that relate to the digital object described. Can be a white space separated list of identifiers.";
  ...
  public static final String VALIDATION_REPORT_SPECIFICATION_AIP13_DESCRIPTION = "Date when the file entry was created.";
