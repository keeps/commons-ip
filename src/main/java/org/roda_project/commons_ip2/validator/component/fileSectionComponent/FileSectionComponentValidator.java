...
public class FileSectionComponentValidator extends MetsValidatorImpl {
  ...
  public static final String HTTPS_DILCIS_EU_XML_METS_CSIPEXTENSION_METS =
   ...
   */
  public FileSectionComponentValidator()
      throws IOException, ParserConfigurationException, SAXException {
    moduleName = Constants.CSIP_MODULE_NAME_5;
    this.contentInformationType =
  ...
  public Map<String, ReporterDetails> validate(
    ...
    notifyObserversValidationStarted(
        moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP58_ID);
    ResultsUtils.addResult(
        results,
        ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP58_ID,
        validateCSIP58(metsValidatorState)
            .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

    if (ResultsUtils.isResultValid(
        results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP58_ID)) {

      /* CSIP59 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP59_ID);
      ResultsUtils.addResult(
          results,
          ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP59_ID,
          validateCSIP59(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

      /* CSIP60 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP60_ID);
      ResultsUtils.addResult(
          results,
      ...
      /* CSIP113 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP113_ID);
      ResultsUtils.addResult(
          results,
      ...
      /* CSIP114 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP114_ID);
      ResultsUtils.addResult(
          results,
      ...
      /* CSIP61 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP61_ID);
      ResultsUtils.addResult(
          results,
          ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP61_ID,
          validateCSIP61(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

      /* CSIP62 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP62_ID);
      ResultsUtils.addResult(
          results,
          ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP62_ID,
          validateCSIP62(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

      /* CSIP63 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP63_ID);
      ResultsUtils.addResult(
          results,
          ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP63_ID,
          validateCSIP63(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

      /* CSIP64 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP64_ID);
      ResultsUtils.addResult(
          results,
      ...
      /* CSIP65 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP65_ID);
      ResultsUtils.addResult(
          results,
          ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP65_ID,
          validateCSIP65(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

      /* CSIP66 */
      notifyObserversValidationStarted(
          moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP66_ID);
      ResultsUtils.addResult(
          results,
      ...
      if (ResultsUtils.isResultValid(
          results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP66_ID)) {

        /* CSIP67 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP67_ID);
        ResultsUtils.addResult(
            results,
            ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP67_ID,
            validateCSIP67(metsValidatorState)
                .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

        /* CSIP68 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP68_ID);
        ResultsUtils.addResult(
            results,
            ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP68_ID,
            validateCSIP68(metsValidatorState)
                .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

        /* CSIP69 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP69_ID);
        ResultsUtils.addResult(
            results,
        ...
        /* CSIP70 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP70_ID);
        ResultsUtils.addResult(
            results,
            ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP70_ID,
            validateCSIP70(metsValidatorState)
                .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION));

        /* CSIP71 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP71_ID);
        try {
          csip =
              validateCSIP71(structureValidatorState, metsValidatorState)
                  .setSpecification(Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION);
        } catch (Exception e) {
          csip =
              new ReporterDetails(
        ...
        ResultsUtils.addResult(
            results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP71_ID, csip);

        /* CSIP72 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP72_ID);
        ResultsUtils.addResult(
            results,
        ...
        /* CSIP73 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP73_ID);
        ResultsUtils.addResult(
            results,
        ...
        /* CSIP74 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP74_ID);
        ResultsUtils.addResult(
            results,
        ...
        /* CSIP75 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP75_ID);
        ResultsUtils.addResult(
            results,
        ...
        /* CSIP76 */
        notifyObserversValidationStarted(
            moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP76_ID);
        ResultsUtils.addResult(
            results,
        ...
        if (ResultsUtils.isResultValid(
            results, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP76_ID)) {

          /* CSIP77 */
          notifyObserversValidationStarted(
              moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP77_ID);
          ResultsUtils.addResult(
              results,
          ...
          /* CSIP78 */
          notifyObserversValidationStarted(
              moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP78_ID);
          ResultsUtils.addResult(
              results,
          ...
          /* CSIP79 */
          notifyObserversValidationStarted(
              moduleName, ConstantsCSIPspec.VALIDATION_REPORT_SPECIFICATION_CSIP79_ID);
          ResultsUtils.addResult(
              results,
          ...
          String message =
              Message.createErrorMessage(
                  "SKIPPED in %1$s because mets/fileSec/fileGrp/file/FLocat doesn't exist",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets());
        ...
        String message =
            Message.createErrorMessage(
                "SKIPPED in %1$s because mets/fileSec/fileGrp/file/ doesn't exist",
                metsValidatorState.getMetsName(), metsValidatorState.isRootMets());
  ...
  private ReporterDetails validateCSIP58(MetsValidatorState metsValidatorState) {
    ...
    if (fileSec == null) {
      ...
      details.addIssue(
          Message.createErrorMessage(
              "mets/fileSec in %1$s can't be null",
              metsValidatorState.getMetsName(), metsValidatorState.isRootMets()));
    }
    return details;
  }
      ...
      if (id != null) {
        if (!metsValidatorState.checkMetsInternalId(id)) {
          ...
          message
              .append("Value ")
              .append(id)
              .append(" in %1$s for mets/fileSec/@ID isn't unique in the package");
        ...
        return new ReporterDetails(
            Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
            Message.createErrorMessage(
                "mets/fileSec/@ID in %1$s can't be null",
                metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
            false,
            false);
      }
   ...
   * group names
   */
  private ReporterDetails validateCSIP60(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      throws IOException {
            ...
            if (structureValidatorState.isZipFileFlag()) {
              for (FileType.FLocat flocat : fLocats) {
                ...
                if (!structureValidatorState
                  ...
                  message
                      .append("mets/fileSec/fileGrp[@USE=’Documentation’] ")
                      .append(filePath)
              ...
              for (FileType.FLocat flocat : fLocats) {
                ...
                if (!structureValidatorState
                    .getFolderManager()
                    .checkPathExists(
                        Paths.get(metsValidatorState.getMetsPath()).resolve(filePath))) {
                  message
                      .append("mets/fileSec/fileGrp[@USE=’Documentation’] ")
   ...
   * names
   */
  private ReporterDetails validateCSIP113(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      throws IOException {
    List<MetsType.FileSec.FileGrp> fileGrps =
        metsValidatorState.getMets().getFileSec().getFileGrp();
          ...
          if (structureValidatorState.isZipFileFlag()) {
            for (FileType.FLocat flocat : fLocats) {
              ...
              if (!structureValidatorState
                  ...
                  .checkPathExists(structureValidatorState.getIpPath(), filePath.toString())) {
                message
                    .append("mets/fileSec/fileGrp[@USE=’Schemas’] ")
                    .append(filePath)
                    .append(" doesn't exists (%1$s)");
                return new ReporterDetails(
                    Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
   ...
   */
  private ReporterDetails validateCSIP114(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      throws IOException {
    List<MetsType.FileSec.FileGrp> fileGrps =
        metsValidatorState.getMets().getFileSec().getFileGrp();
          ...
          if (structureValidatorState.isZipFileFlag()) {
            for (FileType.FLocat flocat : fLocats) {
              ...
              if (!structureValidatorState
                  ...
                  .checkPathExists(structureValidatorState.getIpPath(), filePath.toString())) {
                message
                    .append("mets/fileSec/fileGrp[@USE=’Representations’] ")
                    .append(filePath)
                    .append(" doesn't exists (%1$s)");
                return new ReporterDetails(
                    Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
  ...
  /**
   * mets/fileSec/fileGrp/@ADMID If administrative metadata has been provided at file group
   * mets/fileSec/fileGrp level this attribute refers to its administrative metadata section by ID.
   *
   * <p>Nota: verificar se é id do digiprovMD ou amdSec
   *
      ...
      if (admid != null) {
        ...
        if (!found) {
          ...
          message
              ...
              .append(admid)
              .append(
                  " in %1$s for mets/fileSec/fileGrp/file/@ADMID "
                      + "doesn't match with any mets/amdSec/digiprovMD/@ID");
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  message.toString(),
  ...
  private ReporterDetails validateCSIP62(MetsValidatorState metsValidatorState) {
    ...
    for (MetsType.FileSec.FileGrp fileGrp : fileGrps) {
      if (fileGrp.getUSE() != null && fileGrp.getUSE().matches("Representations/")) {
        QName keyContentInformationType =
            new QName(
                HTTPS_DILCIS_EU_XML_METS_CSIPEXTENSION_METS, "CONTENTINFORMATIONTYPE", "csip");
        ...
        if (cType != null) {
          if (!contentInformationType.contains(cType)) {
            ...
            message
                ...
                .append(cType)
                .append(
                    " in %1$s for mets/fileSec/fileGrp[@USE=’Representations’]"
          ...
          return new ReporterDetails(
              ...
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp[@USE=’Representations’]"
                      + "/@csip:CONTENTINFORMATIONTYPE in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
  ...
  private ReporterDetails validateCSIP63(MetsValidatorState metsValidatorState) {
    ...
    for (MetsType.FileSec.FileGrp fileGrp : fileGrps) {
      QName keyContentInformationType =
          new QName(HTTPS_DILCIS_EU_XML_METS_CSIPEXTENSION_METS, "CONTENTINFORMATIONTYPE", "csip");
      ...
      if (contentInformationType != null && contentInformationType.equals("OTHER")) {
        QName keyOtherContentInformationType =
            new QName(
                HTTPS_DILCIS_EU_XML_METS_CSIPEXTENSION_METS, "OTHERCONTENTINFORMATIONTYPE", "csip");
        String otherContentInformationType =
            fileGrp.getOtherAttributes().get(keyOtherContentInformationType);
        if (otherContentInformationType == null) {
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "In %1$s mets/fileSec/fileGrp/@csip:CONTENTINFORMATIONTYPE "
                      + "have the value OTHER mets/fileSec"
                      + "/fileGrp[@csip:CONTENTINFORMATIONTYPE='OTHER']"
                      + "/@csip:OTHERCONTENTINFORMATIONTYPE can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
    ...
    for (MetsType.FileSec.FileGrp fileGrp : fileGrps) {
      ...
      if (use != null) {
        if (!tmp.contains(use)) {
          if (fileGrp.getFile().isEmpty()) {
            if (structureValidatorState.isZipFileFlag()) {
              String expr;
              if (metsValidatorState.isRootMets()) {
                expr = metsValidatorState.getMets().getOBJID() + "/" + use.toLowerCase();
              } else {
                expr = metsValidatorState.getMetsPath() + use.toLowerCase();
              }
              if (!structureValidatorState
                  .getZipManager()
                  .checkPathIsDirectory(structureValidatorState.getIpPath(), expr)) {
                message
                    .append("Value ")
                    .append(use)
                    .append(
                        " in %1$s for mets/fileSec/fileGrp/@USE "
                            + "doesn't match with any directory in sip(")
                    .append(expr)
                    .append(")");
                return new ReporterDetails(
                    Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              ...
              if (!structureValidatorState
                  .getFolderManager()
                  .checkDirectory(
                      Paths.get(metsValidatorState.getMetsPath()).resolve(use.toLowerCase()))) {
                message
                    .append("Value ")
                    .append(use)
                    .append(
                        " in %1$s for mets/fileSec/fileGrp/@USE "
                            + "doesn't match with any directory in sip(")
                    .append(Paths.get(metsValidatorState.getMetsPath()).resolve(use.toLowerCase()))
                    .append(")");
                return new ReporterDetails(
                    Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                    Message.createErrorMessage(
        ...
        return new ReporterDetails(
            Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
            Message.createErrorMessage(
                "mets/fileSec/fileGrp/@USE in %1$s can't be null",
                metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
            false,
            false);
      }
   ...
   */
  private ReporterDetails validateCSIP65(MetsValidatorState metsValidatorState) {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    ...
    for (MetsType.FileSec.FileGrp grp : fileGrp) {
      ...
      if (id != null) {
        ...
        return new ReporterDetails(
            Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
            Message.createErrorMessage(
                "mets/fileSec/fileGrp/@ID in %1$s can't be null",
                metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
            false,
            false);
      }
  ...
  private ReporterDetails validateCSIP66(
    ...
    if (metsValidatorState.getMetsFiles().containsValue(false) && metsValidatorState.isRootMets()) {
      return new ReporterDetails(
          Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
          Message.createErrorMessage(
              "You have files in SIP does not referenced in %1$s",
              metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
          false,
          false);
    }
      ...
      for (FileType file : files) {
        ...
        if (id != null) {
          ...
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp/file/@ID in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
   ...
   */
  private ReporterDetails validateCSIP68(MetsValidatorState metsValidatorState) {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    List<MetsType.FileSec.FileGrp> fileGrp = fileSec.getFileGrp();
    for (MetsType.FileSec.FileGrp grp : fileGrp) {
      List<FileType> files = grp.getFile();
      for (FileType file : files) {
        ...
        if (mimeType != null) {
          ...
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp/file/@MIMETYPE of file in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
   ...
   */
  private ReporterDetails validateCSIP69(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      throws IOException {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    StringBuilder message = new StringBuilder();
        ...
        if (flocat != null) {
          if (flocat.size() == 1) {
            ...
            if (href != null) {
              ...
              if (size != null) {
                ...
                return new ReporterDetails(
                    Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                    Message.createErrorMessage(
                        "mets/fileSec/fileGrp/file/@SIZE in %1$s can't be null",
                        metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                    false,
                    false);
              }
              ...
              return new ReporterDetails(
                  Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                  Message.createErrorMessage(
                      "mets/fileSec/fileGrp/file/flocat/@href in %1$s can't be null",
                      metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                  false,
                  false);
            }
            ...
            return new ReporterDetails(
                Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                Message.createErrorMessage(
                    "cannot have more than one mets/fileSec/fileGrp/file/flocat in %1$s",
                    metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                false,
                false);
          }
          ...
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp/file/flocat in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
   ...
   */
  private ReporterDetails validateCSIP70(MetsValidatorState metsValidatorState) {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    List<MetsType.FileSec.FileGrp> fileGrp = fileSec.getFileGrp();
    for (MetsType.FileSec.FileGrp grp : fileGrp) {
      List<FileType> files = grp.getFile();
      for (FileType file : files) {
        if (file.getCREATED() == null) {
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp/file/@CREATED in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
   ...
   */
  private ReporterDetails validateCSIP71(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      ...
      for (FileType file : files) {
        ...
        if (checksumType == null) {
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "mets/fileSec/fileGrp/file/@CHECKSUMTYPE in %1$s can't be null",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        } else {
          if (!tmp.contains(checksumType)) {
            ...
            if (checksum == null) {
              return new ReporterDetails(
                  Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                  Message.createErrorMessage(
                      "mets/fileSec/fileGrp/file/@CHECKSUM in %1$s can't be null",
                      metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                  false,
                  false);
            } else {
   ...
   */
  private ReporterDetails validateCSIP72(MetsValidatorState metsValidatorState) {
    List<String> tmp = new ArrayList<>();
    for (CHECKSUMTYPE check : CHECKSUMTYPE.values()) {
      tmp.add(check.toString());
    }
      ...
      for (FileType file : files) {
        ...
        if (ownerID != null) {
          return new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
              Message.createErrorMessage(
                  "A owner identifier was defined in %1$s",
                  metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
              false,
              false);
        }
  ...
  /**
   * mets/fileSec/fileGrp/file/@ADMID If administrative metadata has been provided for the file this
   * attribute refers to the file’s administrative metadata by ID.
   *
   * @param metsValidatorState the contextual METS validator state
  ...
  private ReporterDetails validateCSIP74(final MetsValidatorState metsValidatorState) {
    ...
    final List<String> amdIds =
        amdSec.stream()
            .map(AmdSecType::getDigiprovMD)
            .flatMap(List::stream)
            .filter(dp -> dp.getMdRef() != null)
            .map(dp -> dp.getMdRef().getID())
            .collect(Collectors.toList());

    // Get all file ADMIDs that are NOT in the list of DigiprovMD identifiers
    final List<String> admidsNotInAmd =
        fileGrps.stream()
            .map(FileGrpType::getFile)
            .flatMap(List::stream)
            .map(FileType::getADMID)
            .flatMap(List::stream)
            .filter(MdSecType.class::isInstance)
            .map(MdSecType.class::cast)
            .filter(md -> md.getMdRef() != null)
            .map(md -> md.getMdRef().getID())
            .distinct()
            .filter(admid -> !amdIds.contains(admid))
            .collect(Collectors.toList());
    ...
    for (String admid : admidsNotInAmd) {
      ...
      message
          ...
          .append(
              " in %1$s for mets/fileSec/fileGrp/file/@ADMID "
                  + "does not match with any mets/amdSec/digiprovMd/@ID");
      r.addIssue(
          Message.createErrorMessage(
              message.toString(),
              metsValidatorState.getMetsName(),
   ...
   */
  private ReporterDetails validateCSIP75(MetsValidatorState metsValidatorState) {
    List<MetsType.FileSec.FileGrp> fileGrps =
        metsValidatorState.getMets().getFileSec().getFileGrp();
          ...
          for (Object o : dmdids) {
            ...
            if (!found) {
              ...
              message
                  ...
                  .append(dmdid)
                  .append(
                      " in %1$s for mets/fileSec/fileGrp/file/@DMDID "
                          + "does not match with any mets/dmdSec/mdRef/@ID");
              return new ReporterDetails(
                  Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                  Message.createErrorMessage(
                      message.toString(),
        ...
        if (flocat == null) {
          ...
          if (flocat.size() != 1) {
            return new ReporterDetails(
                Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                Message.createErrorMessage(
                    "Can't have more than one mets/fileSec/fileGrp/file/FLocat in %1$s",
                    metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                false,
                false);
          }
   ...
   */
  private ReporterDetails validateCSIP77(MetsValidatorState metsValidatorState) {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    List<MetsType.FileSec.FileGrp> fileGrp = fileSec.getFileGrp();
    for (MetsType.FileSec.FileGrp grp : fileGrp) {
      List<FileType> files = grp.getFile();
          ...
          for (FileType.FLocat floc : flocat) {
            ...
            if (loctype == null) {
              return new ReporterDetails(
                  Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                  Message.createErrorMessage(
                      "mets/fileSec/fileGrp/file/FLocat[@LOCTYPE=’URL’] in %1$s can't be null",
                      metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                  false,
                  false);
            } else {
                ...
                return new ReporterDetails(
                    ...
                    Message.createErrorMessage(
                        "mets/fileSec/fileGrp/file/"
                            + "FLocat[@LOCTYPE=’URL’] value in %1$s has to be URL ",
                        metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                    false,
                    false);
              }
   ...
   */
  private ReporterDetails validateCSIP79(
      StructureValidatorState structureValidatorState, MetsValidatorState metsValidatorState)
      throws IOException {
    MetsType.FileSec fileSec = metsValidatorState.getMets().getFileSec();
    List<MetsType.FileSec.FileGrp> fileGrp = fileSec.getFileGrp();
          ...
          for (FileType.FLocat floc : flocat) {
            ...
            if (href != null) {
              ...
              if (structureValidatorState.isZipFileFlag()) {
                ...
                if (!structureValidatorState
                    .getZipManager()
                    .checkPathExists(structureValidatorState.getIpPath(), finalPath.toString())) {
                  message
                      .append("mets/fileSec/fileGrp/file/@xlink:href ")
                      .append(finalPath)
              ...
              return new ReporterDetails(
                  Constants.VALIDATION_REPORT_HEADER_CSIP_VERSION,
                  Message.createErrorMessage(
                      "mets/fileSec/fileGrp/file/FLocat/@xlink:href in %1$s can't be null",
                      metsValidatorState.getMetsName(), metsValidatorState.isRootMets()),
                  false,
                  false);
            }
