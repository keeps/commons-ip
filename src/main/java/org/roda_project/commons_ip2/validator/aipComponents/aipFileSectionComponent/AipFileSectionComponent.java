  ...
  public Map<String, ReporterDetails> validate(
    ...
    if (isToValidate) {
      ...
      notifyObserversValidationStarted(
          moduleName, ConstantsAIPspec.VALIDATION_REPORT_SPECIFICATION_AIP9_ID);
      ResultsUtils.addResult(
          results,
          ConstantsAIPspec.VALIDATION_REPORT_SPECIFICATION_AIP9_ID,
          validateAIP9(metsValidatorState)
              .setSpecification(Constants.VALIDATION_REPORT_HEADER_AIP_VERSION));
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              ...
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP74",
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_AIP_VERSION,
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP72 ",
                  metsValidatorState.getMetsName(),
                  metsValidatorState.isRootMets()),
              true,
              true));
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_AIP_VERSION,
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP71 ",
                  metsValidatorState.getMetsName(),
                  metsValidatorState.isRootMets()),
              true,
              true));
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_AIP_VERSION,
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP70 ",
                  metsValidatorState.getMetsName(),
                  metsValidatorState.isRootMets()),
              true,
              true));
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              ...
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP69 ",
                  metsValidatorState.getMetsName(),
                  metsValidatorState.isRootMets()),
              true,
              true));
      ...
      ResultsUtils.addResult(
          ...
          new ReporterDetails(
              Constants.VALIDATION_REPORT_HEADER_AIP_VERSION,
              Message.createErrorMessage(
                  "SKIPPED because it has been validated in CSIP68 ",
                  metsValidatorState.getMetsName(),
                  metsValidatorState.isRootMets()),
              true,
              true));
      ...
      for (MetsType.FileSec.FileGrp fileGrp : fileGrps) {
        ...
        for (FileType file : files) {
          ...
          if (!id.startsWith("ID")) {
            ...
            message
                .append("The mets/fileSec/fileGrp/file/@ID must start with ID in ")
                .append(id)
