 ...
 */
public interface AIPInterface extends IPInterface {
   ...
   */
  AIPInterface addSubmission(IPFile submission);
   ...
   */
  static AIPInterface parse(final Path source) throws ParseException {
   ...
   *           if some error occurred.
   */
  static AIPInterface parse(final Path source, final Path destination) throws ParseException {
    throw new ParseException("One must implement static method parse in a concrete class");
  }
