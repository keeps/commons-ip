...
public final class ValidationConstants {
  ...
  public static final String CSIPSTR1 = "Any Information Package MUST be included within a single physical root folder (known as the “Information Package root folder”). For packages presented in an archive format, see CSIPSTR3, the archive MUST unpack to a single root folder.";
  public static final String CSIPSTR2 = "The Information Package root folder SHOULD be named with the ID or name of the Information Package, that is the value of the package METS.xml’s root <mets> element’s @OBJID attribute.";
  public static final String CSIPSTR3 = "The Information Package root folder MAY be compressed (for example by using TAR or ZIP). Which specific compression format to use needs to be stated in the Submission Agreement.";
  public static final String CSIPSTR4 = "The Information Package root folder MUST include a file named METS.xml. This file MUST contain metadata that identifies the package, provides a high-level package description, and describes its structure, including pointers to constituent representations.";
  public static final String CSIPSTR5 = "The Information Package root folder SHOULD include a folder named metadata, which SHOULD include metadata relevant to the whole package.";
  public static final String CSIPSTR6 = "If preservation metadata are available, they SHOULD be included in sub-folder preservation.";
  public static final String CSIPSTR7 = "If descriptive metadata are available, they SHOULD be included in sub-folder descriptive.";
  public static final String CSIPSTR8 = "If any other metadata are available, they MAY be included in separate sub-folders, for example an additional folder named other.";
  public static final String CSIPSTR9 = "The Information Package folder SHOULD include a folder named representations.";
  ...
  public static final String CSIPSTR11 = "The representation folder SHOULD include a sub-folder named data which MAY include all data constituting the representation.";
  public static final String CSIPSTR12 = "The representation folder SHOULD include a metadata file named METS.xml which includes information about the identity and structure of the representation and its components. The recommended best practice is to always have a METS.xml in the representation folder.";
  public static final String CSIPSTR13 = "The representation folder SHOULD include a sub-folder named metadata which MAY include all metadata about the specific representation.";
  public static final String CSIPSTR14 = "The Information Package MAY be extended with additional sub-folders.";
  public static final String CSIPSTR15 = "We recommend including all XML schema documents for any structured metadata within package. These schema documents SHOULD be placed in a sub-folder called schemas within the Information Package root folder and/or the representation folder.";
