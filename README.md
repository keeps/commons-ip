...
To use commons-ip validator, need to download [Commons IP latest jar](https://github.com/keeps/commons-ip/releases/download/2.0.0-beta1/commons-ip-2.0.0-beta1.jar)
...
* Not using maven, download [Commons IP latest jar](https://github.com/keeps/commons-ip/releases/download/2.0.0-beta1/commons-ip-2.0.0-beta1.jar), each of Commons IP dependencies (see pom.xml to know which dependencies/versions) and add them to your project classpath.
