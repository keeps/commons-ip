...
With the latest version of commons-ip, you can use it as a **Command Line Interface** to validate SIPs or as a library.

### Commons-ip Validator

To use commons-ip validator, need to download [Commons IP latest jar](https://artifactory.keep.pt/artifactory/keep/org/roda-project/commons-ip2/2.0.0-beta1/commons-ip2-2.0.0-beta1.jar)
...
```
java -jar commons-ip-2.0.0-beta1.jar validate -i sip1.zip
```

```
java -jar commons-ip-2.0.0-beta1.jar validate -i sip1.zip sip2.zip -o output/
```
#### Output Example
The report generated by the validator is in **json** format and have the following structure.
...
* Not using maven, download [Commons IP latest jar](https://artifactory.keep.pt/artifactory/keep/org/roda-project/commons-ip2/2.0.0-beta1/commons-ip2-2.0.0-beta1.jar), each of Commons IP dependencies (see pom.xml to know which dependencies/versions) and add them to your project classpath.
