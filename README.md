...
Download the [latest release](https://github.com/keeps/commons-ip/releases/latest) to use as a tool or check below how to use it as a Java Library.
...
To use commons-ip validator, need to download the [latest release](https://github.com/keeps/commons-ip/releases/latest) of the commons-ip tool. Then you can execute in the command-line using the following options:
